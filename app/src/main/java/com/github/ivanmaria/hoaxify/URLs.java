...
public class URLs {
    ...
    public static final String URL_LOAD_NEW_HOAX= ROOT_URL + "load_5.php";
    public static final String URL_LOAD_MY_HOAX= ROOT_URL + "my_post.php";
    public static final String URL_HOAX= ROOT_URL + "hoax_info.php";
