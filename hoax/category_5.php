...
$result=$mysqli->query("SELECT hoax_id, message ,date_time FROM hoax WHERE category_id = (SELECT category_id FROM category WHERE type = '$category') ORDER BY date_time LIMIT 5"); //query to be inserted
